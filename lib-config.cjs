...
module.exports = defaults => {
  ...
  // instance as we do, allowing them to mutate each others keys.
  // This ensures we get our own nconf --- yes it is ugly.
  // Thank you node.js for assuming we always want your hidden cache.
  ...
  nconf.argv()
  // parseValues: true will parse "true" and "false" as booleans,
